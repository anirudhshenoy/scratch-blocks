...
Blockly.Arduino['operator_add'] = function(block) {
  ...
  var X = Blockly.Arduino.valueToCode(
      block, 'NUM1', Blockly.Arduino.ORDER_ATOMIC) || '0';
  var Y = Blockly.Arduino.valueToCode(
      block, 'NUM2', Blockly.Arduino.ORDER_ATOMIC) || '0';
  var code = X + '+' + Y ;
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

/**
 * Generator to subtract 2 numbers
 * Arduino code: X - Y
 * @param {!Blockly.Block} block Block to generate the code from.
 * @return {array} Completed code with order of operation.
 */
...
/**
 * Generator to multiply 2 numbers
 * Arduino code: X * Y
 * @param {!Blockly.Block} block Block to generate the code from.
 * @return {array} Completed code with order of operation.
 */
...
/**
 * Generator to COMPARE LESS THAN
 * Arduino code: X / Y
 * @param {!Blockly.Block} block Block to generate the code from.
 * @return {array} Completed code with order of operation.
 */
...
/**
 * Generator to COMPARE GREATER THAN
 * Arduino code: X / Y
 * @param {!Blockly.Block} block Block to generate the code from.
 * @return {array} Completed code with order of operation.
 */
